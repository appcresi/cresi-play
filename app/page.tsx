...
export const metadata = {
	...
	description:
		"Conocé la nueva forma de aprender y educar sobre diversas temáticas sociales, como la educación sexual, la violencia y la salud.",
} satisfies Metadata;

export default function Home() {
	return (
		<main className="mx-4 flex flex-col items-center gap-8">
