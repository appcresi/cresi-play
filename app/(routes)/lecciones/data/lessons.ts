// Contenido de las lecciones (Pubertad, Sexualidad, Planificación Familiar).
// Separado del componente para que sea más fácil sumar, editar o revisar
// contenido sin tocar la lógica de LessonPage.
//
// El campo `author` está preparado para el día que los docentes puedan
// crear sus propias lecciones (mismo patrón que ya usamos en Trivias:
// 'CRESI' para el contenido oficial, o el id del docente para lo suyo).
// Por ahora todas las lecciones son de CrESI y este archivo es la única
// fuente — cuando se sume la creación por parte de docentes, esa parte
// se combinará con lo que venga de Firestore, sin tener que tocar
// LessonPage.tsx ni Lecciones.tsx.
