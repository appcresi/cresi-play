...
function StoryCard({ story, readingProgress, onSelect }: StoryCardProps) {
  ...
  return (
    <div
      onClick={onSelect}
      className="relative bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-200 cursor-pointer overflow-hidden"
    >
      ...
      <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-3 bg-gray-50 dark:bg-gray-900/40">
    ...
    <div className="mb-6 max-w-2xl mx-auto">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-gray-100 dark:bg-gray-700 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 focus:bg-white dark:focus:bg-gray-700 border border-transparent rounded-xl transition-colors duration-200 outline-none text-base focus:ring-2"
  ...
  if (!currentStory) {
    return (
      <div className="flex items-center justify-center h-96">
        <p className="text-lg text-gray-500 dark:text-gray-400">Cargando historia...</p>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm mb-4">
        <div className="h-28 rounded-t-xl relative" style={{ background: `linear-gradient(to bottom right, ${ACCENT}, ${ACCENT}CC)` }}>
          <button
            onClick={onBack}
            className="absolute top-4 left-4 flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-full shadow-md transition-colors"
          >
        ...
        <div className="p-6 -mt-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">por {currentStory.author}</p>
          </div>
        </div>
      </div>

      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-8 mb-4">
        ...
        {!selectedFeature ? (
          <div className="max-w-7xl mx-auto">
            ...
            {filteredStories.length === 0 && (
              <p className="text-center text-base text-gray-500 dark:text-gray-400 mt-8">
