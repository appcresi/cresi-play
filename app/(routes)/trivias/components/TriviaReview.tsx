    ...
    <section className={showChrome ? 'min-h-screen bg-gray-50 dark:bg-gray-900 p-6' : ''}>
      <div className={showChrome ? 'max-w-6xl mx-auto' : ''}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          {/* Score Card */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Tu Puntuación</h2>
...
function QuestionReview ({ index, question }: QuestionReviewProps): JSX.Element {
  return (
    <div className="bg-gray-50 dark:bg-gray-900/40 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden hover:border-gray-200 dark:hover:border-gray-600 transition-colors">
      {/* Question Header */}
      <div className="bg-white dark:bg-gray-800 p-4 border-b border-gray-100 dark:border-gray-700">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Pregunta {index + 1}</p>
      ...
      <div className="p-4 space-y-3">
        ...
        <div className={`p-3 rounded-lg border ${
          ...
          <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Tu respuesta</p>
        ...
        {!question.isCorrect && (
          <div className="p-3 rounded-lg border" style={{ backgroundColor: `${ACCENT}0D`, borderColor: `${ACCENT}30` }}>
            <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Respuesta correcta</p>
        ...
        <Disclosure>
          {({ open }) => (
            <div className="pt-2">
              <Disclosure.Button className="w-full p-3 flex items-center justify-between rounded-lg bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
              ...
              >
                <Disclosure.Panel className="p-4 mt-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                  {question.resume}
                </Disclosure.Panel>
              </Transition>
            </div>
