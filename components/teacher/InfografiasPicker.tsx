  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <p className="text-sm text-ink/60 dark:text-gray-400">No se pudo cargar el listado de infografías.</p>
      ) : (
        <>
              ...
              return (
                <button
                  ...
                  className={`relative text-left rounded-xl border-2 overflow-hidden transition-all min-w-0 ${
                    isBlocked ? 'border-pink-light dark:border-gray-600 opacity-50 grayscale' : 'border-transparent shadow-sm'
                  }`}
                ...
                >
                  ...
                  <p className="text-[11px] font-medium text-ink dark:text-gray-100 leading-tight p-2 line-clamp-2">
                    {info.title}
                  </p>
                </button>
              );
