    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-5 border-b border-pink-light dark:border-gray-700">
          <h2 className="text-lg font-bold text-ink dark:text-gray-100">{existing ? 'Editar tarea' : 'Nueva tarea'}</h2>
        ...
        <div className="p-5 space-y-4">
          <div>
            <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">Título</label>
            <input
              type="text"
              value={title}
          ...
          <div>
            <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">Consigna</label>
            <textarea
              value={consigna}
          ...
          <div>
            <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">¿Ligada a alguna actividad?</label>
            <select
              value={linkedType}
          ...
          {needsItem && (
            <div>
              <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">Elegí cuál</label>
              {loadingItems ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">Puntos</label>
              <input
                type="number"
                min={0}
                value={points}
            ...
            <div>
              <label className="block text-sm font-semibold text-ink dark:text-gray-100 mb-1">Fecha de entrega</label>
              <input
                type="date"
                value={dueDate}
